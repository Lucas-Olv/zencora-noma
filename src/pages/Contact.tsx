              ...
              <ScrollReveal delay={200}>
                <div>
                  <p className="text-foreground/80 mb-8">
                    Estamos aqui para ajudar! Se você tem dúvidas sobre nossos produtos, precisa de suporte técnico 
                    ou quer saber mais sobre como o Noma pode beneficiar seu negócio, preencha o formulário ou 
                    use um de nossos canais de contato direto.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-foreground/70">contato@zencora.com</p>
                        <p className="text-foreground/70">suporte@zencora.com</p>
                      </div>
                    </div>
          ...
          <section>
            ...
            <div className="mt-12 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl p-8 text-center">
              <p className="text-foreground/80 max-w-2xl mx-auto mb-6">
                Siga-nos nas redes sociais para novidades, dicas e atualizações sobre o Noma e outras soluções da Zencora.
              </p>
              <div className="flex justify-center space-x-4">
                <a href="#" className="bg-background w-12 h-12 rounded-full flex items-center justify-center border hover:border-primary transition-colors">
                ...
                <a href="#" className="bg-background w-12 h-12 rounded-full flex items-center justify-center border hover:border-primary transition-colors">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22.54 6.42C22.4212 5.94541 22.1793 5.51057 21.8387 5.15941C21.498 4.80824 21.0708 4.55318 20.6 4.42C18.88 4 12 4 12 4C12 4 5.12 4 3.4 4.46C2.92925 4.59318 2.50198 4.84824 2.16135 5.19941C1.82072 5.55057 1.57879 5.98541 1.46 6.46C1.14531 8.20556 0.991235 9.97631 1 11.75C0.988786 13.537 1.14285 15.3213 1.46 17.08C1.59096 17.5398 1.83831 17.9581 2.17814 18.2945C2.51798 18.6308 2.93882 18.8738 3.4 19C5.12 19.46 12 19.46 12 19.46C12 19.46 18.88 19.46 20.6 19C21.0708 18.8668 21.498 18.6118 21.8387 18.2606C22.1793 17.9094 22.4212 17.4746 22.54 17C22.8524 15.2676 23.0063 13.5103 23 11.75C23.0112 9.96295 22.8571 8.1787 22.54 6.42Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>

            ...
            <div className="prose prose-lg max-w-none dark:prose-invert">
              <ScrollReveal delay={100}>
                <section className="mb-8">
                  ...
                  <p className="text-foreground/80 mb-4">
                    A Zencora coleta informações que você nos fornece
                    diretamente, como quando você cria uma conta, preenche
                    formulários, utiliza nossos serviços, ou interage com nosso
                    suporte ao cliente. Isso pode incluir:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                    <li>
                      Informações de identificação pessoal (nome, e-mail,
                      telefone)
                    </li>
              ...
              <ScrollReveal delay={200}>
                <section className="mb-8">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                    ...
                    <li>
                      Proteger contra atividades fraudulentas e não autorizadas
                    </li>
                  </ul>
                </section>
              </ScrollReveal>
              ...
              <ScrollReveal delay={400}>
                <section className="mb-8">
                  ...
                  <p className="text-foreground/80">
                    ...
                    perda, alteração ou destruição. Contudo, nenhum método de
                    transmissão pela internet ou armazenamento eletrônico é
                    totalmente seguro, portanto não podemos garantir segurança
                    absoluta.
                  </p>
                </section>
              </ScrollReveal>
              ...
              <ScrollReveal delay={500}>
                <section className="mb-8">
                  ...
                  <p className="text-foreground/80 mb-4">
                    Você tem direitos em relação às suas informações pessoais,
                    incluindo:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                    ...
                    <li>
                      Exclusão de seus dados em determinadas circunstâncias
                    </li>
              ...
              <ScrollReveal delay={600}>
                <section>
                  ...
                  <p className="text-foreground/80">
                    Se você tiver dúvidas ou preocupações sobre nossa Política
                    de Privacidade ou práticas de dados, entre em contato
                    conosco pelo e-mail:{" "}
                    <a
                      href="mailto:privacidade@zencora.com"
                      className="text-primary hover:underline"
                    >
                      privacidade@zencora.com
                    </a>
                  </p>
                </section>
              </ScrollReveal>

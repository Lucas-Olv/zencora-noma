...
function FeatureCard({ icon, title, description, delay }: FeatureCardProps) {
  return (
    <div
      className={`reveal delay-[${delay}] bg-card hover:bg-card/80 border rounded-xl p-6 transition-all duration-300 hover:shadow-md`}
    >
  ...
  const features = [
    {
      ...
      description:
        "Adicione pedidos em poucos segundos e acompanhe o progresso com clareza.",
      delay: "100ms",
    },
    {
      ...
      description:
        "Organize sua produção diária com listas simples e colaborativas.",
      delay: "200ms",
    },
    {
      ...
      description:
        "Visualize seus ganhos e produtividade com gráficos intuitivos.",
      delay: "300ms",
    },
    {
